...
function addMarker (marker, svg, chartHeight, x) {
    ...
    markerG.append('path')
        .attr('d', 'M' + radius + ',' + (chartHeight-yPosStart) + 'L' +
                radius + ',' + (chartHeight-yPosStart) )
        .transition()
        .duration(1000)
        .attr('d', 'M' + radius + ',' + (chartHeight-yPosEnd) + 'L' +
                radius + ',' + (radius * 2) );
...
function makeChart (data, markers) {
    ...
    var xAxis = d3.svg.axis().scale(x).orient('bottom')
                ...
                .outerTickSize(5).tickPadding(10),
